...
type Item struct {
	...
	// SourcePage is the 1-based page inside the chapter-sized PDF object.
	// BookPage and MasterPDFPage retain its stable location in the purchased
	// book and original master PDF for extraction/review work.
